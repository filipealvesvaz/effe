...
var formattedSkills = HTMLskills.replace("%data%", "HTML, CSS, JS");
...
var project = {
	...
	"display": function(){
        ...
        $(".project-entry:last").append(formattedTitle, formattedDates, formattedDescription, formattedprojectImage) //, formattedprojectLink)
        })
    }
}
project.display()
